...
func (m *MockToken) WaitTimeout(duration time.Duration) bool	{ return true }
...
func (m *MockBusinessLogicHandlers) OnLoginEvent(event protocol.Event) protocol.Event {
	return protocol.Event{}
}
func (m *MockBusinessLogicHandlers) OnBuyCardPackEvent(event protocol.Event) protocol.Event {
	return protocol.Event{}
}
func (m *MockBusinessLogicHandlers) OnTradeEvent(event protocol.Event) protocol.Event {
	return protocol.Event{}
}
func (m *MockBusinessLogicHandlers) OnListUserCardsEvent(event protocol.Event) protocol.Event {
	return protocol.Event{}
}
func (m *MockBusinessLogicHandlers) OnStartMatchEvent(event protocol.Event) protocol.Event {
	return protocol.Event{}
}
func (m *MockBusinessLogicHandlers) OnPlayCardEvent(event protocol.Event) protocol.Event {
	return protocol.Event{}
}
func (m *MockBusinessLogicHandlers) OnGetMatchResultEvent(event protocol.Event) protocol.Event {
	return protocol.Event{}
}
func (m *MockBusinessLogicHandlers) OnPlayerSurrenderEvent(event protocol.Event) protocol.Event {
	return protocol.Event{}
}
